...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(default="", max_length=30, verbose_name='类别', help_text='类别')
    code = models.CharField(default="", max_length=30, verbose_name='类别code', help_text='类别code')
    desc = models.TextField(default="", verbose_name='类别描述', help_text='类别描述')
    category_type = models.IntegerField(choices=CATEGORY_TYPE, verbose_name='类目级别', help_text='类目级别')
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name='父类', help_text='父类', related_name='sub_cat', on_delete=models.CASCADE)
...
class Goods(models.Model):
    ...
    name = models.CharField(max_length=300, verbose_name='商品标题')
...
class GoodsImage(models.Model):
    ...
    image_url = models.CharField(max_length=300, null=True, blank=True, verbose_name='主图url')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
