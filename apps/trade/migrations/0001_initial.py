    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('py_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('waite_pay', '待支付')], max_length=10, verbose_name='订单状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('goods', models.ForeignKey(on_delete='CASCADE', to='goods.Goods', verbose_name='商品')),
            ],
            options={
                'verbose_name': '购物车',
